...
public class AdocaoService {
    ...
    public void solicitar(SolicitacaoDeAdocaoDTO dto){
        ...
        var petAdocaoEmAndamento = adocaoRepository.existsByPetIdAndStatus(dto.idPet(), StatusAdocao.AGUARDANDO_AVALIACAO);

        if (petAdocaoEmAndamento) {
            throw new AdocaoException("Pet com adoção em andamento");
        }

        var tutorAdocoes = adocaoRepository.countByTutorIdAndStatus(dto.idPet(), StatusAdocao.APROVADO);
